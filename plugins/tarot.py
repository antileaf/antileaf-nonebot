...
major_tarot = [
    ...
    ('魔术师', 'The Magician', ('事情的开始，行动的改变，熟练的技术及技巧，贯彻自我意志，运用自然的力量来达到目的', '意志力薄弱，起头难，走入错误的方向，知识不足，被骗和失败')),
    ('女祭司', 'The High Priestess', ('开发出内在的神秘潜力，前途将有所变化的预言，深刻的思考，敏锐的洞察力，准确的直觉', '洁癖，无知，贪心，目光短浅，自尊心过高，偏差的判断，有勇无谋，自命不凡')),
    ('女皇', 'The Empress', ('幸福，成功，收获，无忧无虑，圆满的家庭生活，良好的环境，美貌，艺术，与大自然接触，愉快的旅行，休闲', '不活泼，缺乏上进心，散漫的生活习惯，无法解决的事情，不能看到成果，贪于享乐，环境险恶，与家人发生纠纷')),
    ...
    ('恋人', 'The Lovers', ('撮合，爱情，流行，兴趣，充满希望的未来，魅力，增加朋友', '禁不起诱惑，纵欲过度，反复无常，友情变淡，厌倦，争吵，华丽的打扮，优柔寡断')),
    ('战车', 'The Chariot', ('努力而获得成功，胜利，克服障碍，行动力，自立，尝试，自我主张，年轻男子，交通工具，旅行运大吉', '争论失败，发生纠纷，阻滞，违反规则，诉诸暴力，顽固的男子，突然的失败，不良少年，挫折和自私自利')),
    ('力量', 'Strength', ('大胆的行动，有勇气的决断，新发展，大转机，异动，以意志力战胜困难，健壮的女人', '胆小，输给强者，经不起诱惑，屈服在权威与常识之下，没有实践便告放弃，虚荣，懦弱，没有耐性')),
    ('隐士', 'The Hermit', ('隐藏的事实，个别的行动，倾听他人的意见，享受孤独，有益的警戒，年长者，避开危险，祖父，乡间生活', '无视警告，憎恨孤独，自卑，担心，幼稚思想，过于慎重导致失败，偏差，不宜旅行')),
    ...
    ('高塔', 'The Tower', ('破产，逆境，被开除，突然患病，致命的打击，巨大的变动，受牵连，信念崩溃，玩火自焚，纷扰不断，突然分离，破灭的爱', '困境，内讧，紧迫的状态，状况不佳，趋于稳定，骄傲自大将付出代价，背水一战，分离的预感，爱情危机')),
